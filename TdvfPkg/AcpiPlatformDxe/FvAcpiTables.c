...
/**
  ...
  sources for the FV based tables is located under TdvfPkg/AcpiTables.
...
EFI_STATUS
EFIAPI
FvAcpiPlatformEntryPoint (
  IN EFI_HANDLE         ImageHandle,
  IN EFI_SYSTEM_TABLE   *SystemTable
  )
{
  EFI_STATUS Status;
  Status = AcpiPlatformEntryPoint(ImageHandle, SystemTable, InstallAcpiTablesFromFv);
  return Status;
}
